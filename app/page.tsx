...
export default function Portfolio() {
  const skills = ["Machine Learning", "Artificial Intelligence", "Python", "Javascript", "Node.js", "Tensorflow"];
  const projects = ["Driver Drowsiness Detection", "License Plate Recognition", "Weeds Detection", "Sentiment Analysis"];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-green-800 text-white flex flex-col items-center px-8">
      ...
      <section className="relative w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-10 mt-16">
        ...
        >
          <Image
            src="/images/cartoon-boy.webp"
            alt="Cartoon illustration of Gokul"
            width={250}
            height={250}
